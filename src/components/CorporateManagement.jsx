...
const CorporateManagement = () => {
  ...
  return (
    <div className='w-full h-full relative pl-20 pr-20 gap-2 pt-10'>

            <div className='relative ' data-aos="fade-up">
                <h1 className='border-r-8 border-blue-500 pl-5 pr-5 text-4xl font-normal text-blue-900 text-right'> Corporate <span className='font-black text-blue-700'> Management </span></h1>
                <p className='border-r-8 border-blue-500 pl-5 pr-5 pt-1 text-xl font-light italic text-blue-500 text-right'>Comprehensive Solutions for Secure Financial Growth</p>
                <p className='pb-5 pt-5 text-sm font-normal text-stone-500 text-justify'>At Asia Asset Finance, our corporate management team is composed of seasoned professionals who bring a wealth of experience and insight to the table. Their strategic leadership and commitment to excellence drive our company’s success, ensuring we remain at the forefront of Sri Lanka’s financial services industry.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-5 justify-items-center md:justify-items-stretch">
