...
const MissionVisionGoal = () => {
  ...
  return (
    <div className="px-10 lg:px-40 py-10 bg-black/30 shadow justify-end items-center gap-10 lg:gap-40 inline-flex">
      <div className="flex-col justify-start items-start flex gap-5">
        ...
        >
          <div className="text-white text-xl md:text-2xl lg:text-4xl font-black">MISSION</div>
        </div>
        <div
        ...
        >
          <div className="text-white text-xl md:text-2xl lg:text-4xl font-black">VISION</div>
        </div>
        <div
        ...
        >
          <div className="text-white text-xl md:text-2xl lg:text-4xl font-black font-['Roboto']">GOAL</div>
        </div>
      </div>
      <div className="flex-col justify-center items-start gap-2.5 inline-flex">
        <div className="text-white text-xl md:text-2xl lg:text-4xl font-bold">{tabContent[activeTab].title}</div>
        <div className="self-stretch text-white text-xs md:text-sm lg:text-lg font-normal">{tabContent[activeTab].description}</div>
      </div>
    </div>
  );
}
