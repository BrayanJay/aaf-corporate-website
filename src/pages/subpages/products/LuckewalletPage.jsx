...
const LuckewalletPage = () => {
  ...
  const image = {
    src: `${import.meta.env.VITE_API_BASE_URL}/media/products/luckewalletPgBanner4.webp`,
    title: data.title,
    intro:data.subtitle,
  };
  ...
  return (
    <div id='main-container'>
      ...
      <div className="relative">
        ...
        <div className="absolute left-0 bottom-0 flex gap-1 sm:gap-2 md:gap-3 lg:gap-5 p-5">
          <a href="https://apps.apple.com/lk/app/asia-asset-luckewallet/id1637028447">
            <img className="w-24 lg:w-36 hover:cursor-pointer hover:shadow-lg" src={`${import.meta.env.VITE_API_BASE_URL}/media/icons/appStoreBtn.webp`} alt="App Store"/>
          </a>
          <a href="https://play.google.com/store/apps/details?id=com.AsiaAsset.luckewallet&pli=1">
            <img className="w-24 lg:w-36 hover:cursor-pointer hover:shadow-lg" src={`${import.meta.env.VITE_API_BASE_URL}/media/icons/playStoreBtn.webp`} alt="Play Store"/>
          </a>
        </div>
      </div>
      ...
      <ProductLuckewallet 
        MobilePic={`${import.meta.env.VITE_API_BASE_URL}/media/products/luckewallet.webp`} 
        logo={`${import.meta.env.VITE_API_BASE_URL}/media/logos/luckewalletlogo.webp`}
      />
      <div className='flex justify-center p-10 gap-5 bg-white'>
      <a href={`${import.meta.env.VITE_API_BASE_URL}/media/attachments/products/luckewallet/kfd/${i18n.language}_key_fact_document_s.pdf`}
          target="_blank"
