...
const Mortgage = () => {
  ...
  const image = {
    src: `${import.meta.env.VITE_API_BASE_URL}/media/products/mortgagePgBanner.webp`,
    title: data.title,
  };
  ...
  return (
    <div id='main-container'>
      ...
      <a href={`${import.meta.env.VITE_API_BASE_URL}/media/attachments/products/mortgage/kfd/${i18n.language}_key_fact_document_m.pdf`} target="_blank" rel="noopener noreferrer"><div className='px-3 py-1.5 border-2 border-blue-500 text-blue-500 text-xs sm:text-base hover:text-white text-center hover:bg-bluegradient transition-colors ease-in-out duration-200 font-medium cursor-pointer rounded-xl items-center justify-center' aria-label={data.btn_1}>{data.btn_1}</div></a>
      <a href={`${import.meta.env.VITE_API_BASE_URL}/media/attachments/products/mortgage/tariff/${i18n.language}_m_cat.png`}><div className='px-3 py-1.5 border-2 border-blue-500 text-blue-500 text-xs sm:text-base hover:text-white text-center hover:bg-bluegradient transition-colors ease-in-out duration-200 font-medium cursor-pointer rounded-xl items-center justify-center' aria-label={data.btn_2}>{data.btn_2}</div></a>
